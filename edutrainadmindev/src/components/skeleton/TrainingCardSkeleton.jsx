        ...
        <div key={index} className="bg-primary-white rounded-xl shadow-2xl h-fit relative overflow-hidden">
          ...
          <div className="py-3 px-3">
            <div className="flex items-center gap-1 animate-pulse">
              <div className="w-20 h-5 bg-secondary-greydark rounded-full"></div>
            </div>
            ...
            <div className="flex items-center justify-between animate-pulse">
              <div className="w-1/3 h-4 bg-secondary-greydark rounded-full"></div>
              <div className="w-1/3 h-5 bg-secondary-greydark rounded-full"></div>
            </div>

            <div className="mt-2 flex justify-between animate-pulse">
              <div className="w-2/5 h-5 bg-secondary-greydark rounded-full"></div>
              <div className="w-2/5 h-5 bg-secondary-greydark rounded-full"></div>
            </div>
